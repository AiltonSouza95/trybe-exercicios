/*Usando o objeto abaixo, faça os exercícios a seguir, Imprima no console uma 
mensagem de boas-vindas para a personagem acima, incluindo seu nome.*/
let info = {
...
/*Usando o objeto abaixo, faça os exercícios a seguir, Acesse as chaves nome, 
sobrenome e titulo, que está dentro da chave livrosFavoritos, e faça um console.log 
no seguinte formato: “O livro favorito de Julia Pessoa se chama ‘O Pior Dia de 
Todos’”.*/
let leitor = {
    nome: 'Julia',
    sobrenome: 'Pessoa',
